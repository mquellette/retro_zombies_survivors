...
export const CONFIG = {
  ...
  statUpgrades: {
    moveSpeed: {
      ...
      desc: 'Навсегда повышает скорость бега',
    ...
    atkSpeed: {
      ...
      desc: 'Навсегда повышает скорость атаки',
    ...
    maxHp: {
      ...
      desc: 'Навсегда повышает максимальное здоровье',
    ...
    damage: {
      ...
      desc: 'Навсегда повышает силу атаки',
  ...
  weapons: {
    ...
    guitar: {
      ...
      type: 'aoe',
      desc: 'Раз в несколько секунд бьёт по область вокруг игрока',
      maxLevel: 5,
      levels: [
    ...
    shotgun: {
      ...
      type: 'spread',
      desc: 'Стреляет дробью вблизи, отбрасывая противников',
      maxLevel: 5,
      levels: [
    ...
    boomerang: {
      id: 'boomerang',
      name: 'Бумеранг',
      icon: `${BASE}Assets/UI/Icons/Weapons/ic-weapon-boomerang.png`,
      type: 'boomerang',
    ...
    chainsaw: {
      id: 'chainsaw',
      name: 'Бензопила',
      icon: `${BASE}Assets/UI/Icons/Weapons/ic-weapon-chainsaw.png`,
      type: 'orbit',
      desc: 'Летает вокруг персонажа и наносит урон',
      maxLevel: 5,
      levels: [
    ...
    skateboard: {
      id: 'skateboard',
      name: 'Скейтборд',
      icon: `${BASE}Assets/UI/Icons/Weapons/ic-weapon-skateboard.png`,
      type: 'trail',
      desc: 'Разбрасывает врагов по траектории движения',
      maxLevel: 5,
      levels: [
